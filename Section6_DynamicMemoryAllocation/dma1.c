...
int main() {
    ...
    // The result of the malloc function is a block of memory that is allocated on the heap, which is a region
    // of the computer's memory used for dynamic memory allocation. The malloc function returns a void pointer
